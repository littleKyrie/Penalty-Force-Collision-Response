...
//Output:
//  dphi - the 4x3 gradient of the basis functions wrt to X. The i'th row stores d phi_i/dX
...
void dphi_linear_tetrahedron_dX_v(Eigen::Matrix43d &dphi, Eigen::Ref<const Eigen::MatrixXd> V, Eigen::Ref<const Eigen::RowVectorXi> element, Eigen::Ref<const Eigen::Vector3d> X);
